...
class TestCollectionReference(TestCase):
    ...
    def test_collection_whereNestedField(self):
        fs = MockFirestore()
        fs._data = {"foo": {"first": {"nested": {"a": 1}}, "second": {"nested": {"a": 2}}}}
    ...
    def test_collection_orderBy_descending(self):
        fs = MockFirestore()
        fs._data = {"foo": {"first": {"order": 2}, "second": {"order": 3}, "third": {"order": 1}}}
    ...
    def test_collection_offset(self):
        fs = MockFirestore()
        fs._data = {"foo": {"first": {"id": 1}, "second": {"id": 2}, "third": {"id": 3}}}
    ...
    def test_collection_limitAndOrderBy(self):
        fs = MockFirestore()
        fs._data = {"foo": {"first": {"order": 2}, "second": {"order": 1}, "third": {"order": 3}}}
